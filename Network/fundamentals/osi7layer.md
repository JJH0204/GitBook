...
| -- | ----------------------------------- | ----------------------- | --------------------------- |
| 7  | <p>응용 계층<br>Application Layer</p>   | 사용자와 네트워크 간 상호작용        | HTTP, FTP, SMTP, DNS        |
| 6  | <p>표현 계층<br>Presentation Layer</p>  | 데이터 형식 변환, 암호화/복호화      | JPEG, MP3, ASCII, TLS, SSL  |
| 5  | <p>세션 계층<br>Session Layer</p>       | 통신 세션 관리, 연결 설정 및 종료    | NetBIOS, RPC, PPTP          |
| 4  | <p>전송 계층<br>Transport Layer</p>     | 신뢰성 있는 데이터 전송, 흐름/오류 제어 | TCP, UDP                    |
| 3  | <p>네트워크 계층<br>Network Layer</p>     | 데이터 패킷 라우팅, IP 주소 관리    | <p>IP, ICMP, ARP<br>라우터</p> |
| 2  | <p>테이터 링크 계층<br>Data Link Layer</p> | 물리적 주소(MAC)관리, 오류 감지    | 이더넷, 스위치, MAC 주소            |
| 1  | <p>물리 계층<br>Physical Layer</p>      | 전기적 신호, 데이터 전송 매체       | 케이블, 허브, 리피터                |
...
송신 측에서 7계층 → 1계층으로 내려가고, 수신 측에서 1계층 → 7계층으로 올라간다.
