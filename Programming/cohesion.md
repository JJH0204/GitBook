...
"모듈 내부의 기능들이 얼마나 하나의 목적을 위해 집중되어 있는가?"를 측정하는 지표

***

### 응집도의 중요성

* 높은 응집도: 모듈이 단일 책임 원칙(SRP)을 따르며, 유지보수가 쉽고 재사용성이 높다.
...
* tokenize → parse → generateCode 순서로 데이터가 흐른다.
{% endstep %}
