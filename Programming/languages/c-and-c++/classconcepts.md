...
{% step %}
### 생성자와 소멸자 (Initializers N Deinitializers)
...
{% step %}
### 참조 카운팅 (Reference Counting) 또는 가비지 콜랙터
...
{% step %}
### 클래스 프로퍼티와 메서드 (Class Properties and Methods)
...
[클래스 와 구조체의 차이점](/broken/pages/fba7b2b039833de8f21bb8c224cf4a4bc533a229)
