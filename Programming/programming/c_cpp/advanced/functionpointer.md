...
{% stepper %}
{% step %}
프로그램 실행 흐름을 유연하게 제어할 수 있다. (콜백 함수를 구현하는 등 다양한 프로그래밍 기법을 가능하게 함)
{% endstep %}

{% step %}
함수 포인터를 매개변수로 받는 함수 정의 가능하다. 전달되는 인자에 따라 달리 동작하는 함수를 구현할 수 있다.
{% endstep %}
